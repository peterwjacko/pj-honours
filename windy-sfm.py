...
# %%
droneFriday.loc[droneFriday['ObjectNum'] == 179, 'GeoRaster'].item().plot()
lidarFriday.loc[lidarFriday['ObjectNum'] == 179, 'GeoRaster'].item().plot()
# %%
# sort by objectNum
...
# Drone CHM #
fridayDroneMeans = pd.DataFrame(fridayDroneCHM.max())
mondayDroneMeans = pd.DataFrame(mondayDroneCHM.max())

# Lidar CHM #
fridayLidarMeans = pd.DataFrame(fridayLidarCHM.max())
mondayLidarMeans = pd.DataFrame(mondayLidarCHM.max())
...
bothDaysBothCHM= sns.histplot(x='Height',
...
bothDaysBothCHM = sns.boxplot(x='CHM',
                            y='Height',
                            data=lidarDroneStacked,
                            hue=None,
                            orient="v")
